...
const (
	WorkerService_UpdateJobStatus_FullMethodName = "/worker.WorkerService/UpdateJobStatus"
	WorkerService_HealthCheck_FullMethodName     = "/worker.WorkerService/HealthCheck"
)
...
type WorkerServiceClient interface {
	UpdateJobStatus(ctx context.Context, in *JobStatusRequest, opts ...grpc.CallOption) (*JobStatusResponse, error)
...
func (c *workerServiceClient) UpdateJobStatus(ctx context.Context, in *JobStatusRequest, opts ...grpc.CallOption) (*JobStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(JobStatusResponse)
	err := c.cc.Invoke(ctx, WorkerService_UpdateJobStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WorkerServiceServer interface {
	UpdateJobStatus(context.Context, *JobStatusRequest) (*JobStatusResponse, error)
...
func (UnimplementedWorkerServiceServer) UpdateJobStatus(context.Context, *JobStatusRequest) (*JobStatusResponse, error) {
...
func _WorkerService_UpdateJobStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorkerService_UpdateJobStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkerServiceServer).UpdateJobStatus(ctx, req.(*JobStatusRequest))
	}
