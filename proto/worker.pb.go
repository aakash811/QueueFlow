...
func (x *JobStatusRequest) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
const file_proto_worker_proto_rawDesc = "" +
	"\n" +
	"\x12proto/worker.proto\x12\x06worker\"A\n" +
	"\x10JobStatusRequest\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\"-\n" +
	"\x11JobStatusResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"\x0f\n" +
	"\rHealthRequest\"(\n" +
	"\x0eHealthResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status2\x95\x01\n" +
	"\rWorkerService\x12F\n" +
	"\x0fUpdateJobStatus\x12\x18.worker.JobStatusRequest\x1a\x19.worker.JobStatusResponse\x12<\n" +
	"\vHealthCheck\x12\x15.worker.HealthRequest\x1a\x16.worker.HealthResponseB\tZ\a./protob\x06proto3"
...
var file_proto_worker_proto_goTypes = []any{
	(*JobStatusRequest)(nil),  // 0: worker.JobStatusRequest
	(*JobStatusResponse)(nil), // 1: worker.JobStatusResponse
...
var file_proto_worker_proto_depIdxs = []int32{
	0, // 0: worker.WorkerService.UpdateJobStatus:input_type -> worker.JobStatusRequest
	2, // 1: worker.WorkerService.HealthCheck:input_type -> worker.HealthRequest
	1, // 2: worker.WorkerService.UpdateJobStatus:output_type -> worker.JobStatusResponse
	3, // 3: worker.WorkerService.HealthCheck:output_type -> worker.HealthResponse
